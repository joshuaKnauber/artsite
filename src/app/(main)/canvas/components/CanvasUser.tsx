...
const CanvasUser = ({
  ...
  const outOfBounds = x !== presence.cursor.x || y !== presence.cursor.y;
  ...
  return (
    <div
      ...
      className="absolute z-10 transition-all duration-[20ms] ease-linear"
      style={{
        transform: `translate(${outOfBounds ? x : x + 26}px, ${
          outOfBounds ? y : y + 26
        }px)`,
      }}
    >
